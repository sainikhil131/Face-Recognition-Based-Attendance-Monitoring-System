...
def contact():
    mess._show(title='Contact us', message="Please contact us on : 'hitam@gmail.com' ")
...
message3 = tk.Label(window, text="HITAM Face Recognition Attendance Monitoring System" ,fg="white",bg="#2d420a" ,width=55 ,height=1,font=('comic', 29, ' bold '))
